...
export default function PropietariosView() {
  const datos = [
    { id: 'PROP-01', nombre: 'María García', telefono: '+34 612 345 678', email: 'maria@gmail.com', mascota: 'Luna' },
    { id: 'PROP-02', nombre: 'Juan Pérez', telefono: '+34 699 888 777', email: 'juan@outlook.com', mascota: 'Max' }
  ];
  ...
  return (
    <div className="w-full flex flex-col gap-6">
      <div className="flex items-center justify-between w-full">
        <div className="flex flex-col gap-1">
          <div className="flex items-center gap-3">
            ...
            <h1 className="text-3xl font-bold text-gray-800 tracking-tight">Propietarios</h1>
          </div>
          <span className="text-sm text-gray-500 font-medium">{datos.length} clientes registrados</span>
        </div>
      ...
      <div className="w-full max-w-xl relative">
        ...
        <input type="text" placeholder="Buscar propietarios..." className="w-full pl-12 pr-4 py-3 bg-[#fafaf6] border border-gray-200 rounded-2xl text-sm focus:outline-none focus:border-emerald-700 font-medium text-gray-700 transition-colors" />
      </div>
          ...
          <table className="w-full text-left border-collapse">
            <thead>
              <tr className="border-b border-gray-200/60 text-xs font-bold text-gray-400 tracking-wider bg-gray-50/50">
                ...
                <th className="py-4 px-6">MASCOTA ASOCIADA</th>
            ...
            <tbody className="text-sm font-medium text-gray-700 divide-y divide-gray-100">
              {datos.map((reg) => (
                <tr key={reg.id} className="hover:bg-gray-50/50 transition-colors">
                  ...
                  <td className="py-4 px-6 font-bold text-emerald-800">{reg.mascota}</td>
